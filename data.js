const TEMPLATES = [
  ...
  },
  {
    ...
    "keywords": "dysmenorrhea period pain menstrual cramps pelvic pain primary secondary",
    "history": "Patient no past medical illness, no known drug allergies.\n\nPresented to the ED with lower abdominal / pelvic pain associated with menstruation.\n\nLMP: ______. Cycle normally regular / irregular.\n\nPain onset: with period / before period, duration ___  days, severity ___/10.\n\nAssociated with nausea / vomiting / diarrhea / back pain as documented.\n\nPrior similar episodes with periods: yes / no.\n\nSexually active: yes / no. Contraception: ______.\n\nPregnancy possibility reviewed - beta-hCG: pending / negative / positive.\n\nDenied fever, abnormal vaginal discharge, dyspareunia, intermenstrual bleeding, syncope, shoulder tip pain, or other symptoms.",
    "exam": "Conscious, alert and oriented, not in distress.\nGCS 15/15.\nVital signs reviewed, afebrile.\n\nCVS: S1 + S2, no murmur.\nChest: equal air entry bilaterally, no added sounds.\n\nPA: soft, lax, suprapubic / lower abdominal tenderness as documented, no guarding, no rigidity, no rebound tenderness, bowel sounds present.\n\nPelvic examination findings documented if performed:\nNo cervical motion tenderness.\nNo adnexal tenderness / mass.\nNo abnormal discharge.",
    "mdm": "Presentation most consistent with primary dysmenorrhea.\n\nDifferential diagnoses considered including primary dysmenorrhea, secondary dysmenorrhea (endometriosis, fibroids, adenomyosis), ectopic pregnancy, ovarian torsion, ruptured ovarian cyst, PID, appendicitis, UTI, and renal colic as appropriate.\n\nPregnancy excluded / beta-hCG negative.\n\nInvestigations reviewed if performed.\n\nNo evidence of ectopic pregnancy, ovarian torsion, or other acute surgical/gynecological emergency requiring admission at present.",
    "discharge": "Feels better.\n\nAnalgesia (NSAIDs / paracetamol) and follow-up advice explained.\n\nSafety ER return instructions explained including worsening or severe pain, syncope, heavy vaginal bleeding, positive pregnancy test, fever, persistent vomiting, shoulder tip pain, abnormal discharge, or any other concerns.\n\nFollow up with primary care/OB-Gyn for further evaluation if recurrent or worsening symptoms."
  }
